const subjects = {
  ...
  KGSM: [
    ...
    { symbol: "FINCM", name: "Finance" },
    { symbol: "HCAK", name: "Health Care at Kellogg" },
    { symbol: "INTL", name: "International Business" },
    { symbol: "INTLM", name: "International Business" },
    ...
    { symbol: "MECNM", name: "Managerial Economics" },
    ...
    { symbol: "MORSM", name: "Management and Organizations" },
  ...
  MEAS: [
    ...
    { symbol: "DATA_ENG", name: "Data Science & Engineering" },
  ...
  SPCH: [
    ...
    {
      symbol: "EPICS",
      name: "External Programs, Internships, & Career Services",
    },
  ...
  TGS: [
    ...
    { symbol: "MDVL_ST", name: "Medieval Studies" },

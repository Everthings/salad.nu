const subjects = {
  DOHA: [
    ...
    { symbol: "GEN_CMN", name: "General Communication & Introductory Courses" },
    { symbol: "HISTORY", name: "History" },
    { symbol: "INTERDIS", name: "Interdisciplinary Studies" },
    { symbol: "JOUR", name: "Journalism" },
    { symbol: "MIT", name: "Media Industries and Technologies" },
    { symbol: "PHIL", name: "Philosophy" },
    { symbol: "POLI_SCI", name: "Political Science" },
    { symbol: "SOCIOL", name: "Sociology" },
    { symbol: "STRATCOM", name: "Strategic Communication" },
  ],
  JOUR: [
  ...
  KGSM: [
    ...
    { symbol: "MECS", name: "Managerial Economics and Strategy" },
  ...
  TGS: [
    ...
    { symbol: "IGP", name: "Integrated Life Sciences" },
  ...
  UC: [
    ...
    { symbol: "BUS_DM", name: "Business Analytics for Decision Makers" },
    { symbol: "BUS_LAW", name: "Business Law" },
